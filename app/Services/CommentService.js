...
module.exports = {
    ...
    index: callBack => {
        let _query = `SELECT s.SID, CONCAT(s.Fname,' ' ,s.Lname) as student_name, CONCAT(cl.curriculum,' - ',cl.year_level, cl.section) AS course, sub.code, sub.subject, f.name, f.department, comment,
 ef.created_at FROM comments AS ef
